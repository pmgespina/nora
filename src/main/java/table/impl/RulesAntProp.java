...
public class RulesAntProp extends CassandraTable {

    public RulesAntProp(Database database) {
        super("RulesAntProp", database);
    ...
    public static class Row implements Serializable {
        ...
        public String toString() {
            return MessageFormat.format("RulesAntProp'{'ruleid={0}, num={1}, domain={2}, prop={3}, range={4}'}'", ruleid, num, domain, prop, range);
        }
    }
}
